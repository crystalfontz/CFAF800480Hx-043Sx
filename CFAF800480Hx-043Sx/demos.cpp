//============================================================================
//
// Some demo routines for Crystalfontz EVE accelerated displays.
//
...
#if (0==BMP_SCROLL) //1 for scroll, 0 for static bitmap
  FWol=FLASH_SETBITMAP(FWol,FLASH_SECTOR_SPLASH,EVE_FORMAT_COMPRESSED_RGBA_ASTC_8x8_KHR,800,480);
...
//for testing Reset_EVE_Coprocessor()
  ...
  if(0==first)
    ...
    //bad
    FWol=EVE_Inflate_to_RAM_G(FWol,
                              CFAF800480Hx_043Sx_ARGB2_LOGO+20,
                              LOGO_SIZE_ARGB2,
                              RAM_G_Unused_Start);
