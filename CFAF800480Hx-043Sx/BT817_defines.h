#ifndef __BT817_DEFINES_H__
#define __BT817_DEFINES_H__
//============================================================================
//
// Definitions specific to the BT817 EVE
//
...
#define LOGO_PNG_0_ARGB2_1   (0)  //Compressed ARGB is smaller
...
#define FLASH_LENGTH_MARBLE (8388736UL) // sectors: 2048
...
#define HBP   (43)      // Horizontal Back Porch (must be 46, includes HSW)
...
#define VBP   (12)     // Vertical Back Porch (must be 23, includes VS)
